...
\begin{titlepage}
  ...
  \begin{center}
    \vspace*{\fill}
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{cover_titled.jpg}
    \vspace*{\fill}
  \end{center}
\end{titlepage}
...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \vfill
    {\large \copyright\ 2026 Gaius Jocundus \& Thalia Ephemera\\[0.4em]
    \normalsize Licencia CC BY 4.0 --- libre para uso comercial con atribución\\[0.2em]
...
\clearpage
\input{chapters/lenormand_playing_card_oracle}
